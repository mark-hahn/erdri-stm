...
#if defined (STM8S208) || defined(STM8S207) || defined(STM8S105) || defined(STM8AF52Ax) || defined(STM8AF62Ax) || defined(STM8AF626x)
...
#elif defined (STM8S105) || defined (STM8AF626x)
